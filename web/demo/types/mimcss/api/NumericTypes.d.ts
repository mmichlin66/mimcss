 ...
 */
export declare type CssPercent = number | IPercentProxy | `${number}${PercentUnits}`;
/**
...
/** Units of length */
export declare type LengthUnits = PercentUnits | "Q" | "ch" | "cm" | "em" | "ex" | "ic" | "in" | "lh" | "mm" | "pc" | "pt" | "px" | "vb" | "vh" | "vi" | "vw" | "rem" | "rlh" | "vmax" | "vmin" | "fr";
 ...
 */
export declare type CssLength = CssPercent | ILengthProxy | `${number}${LengthUnits}`;
/**
...
/** Units of angle */
export declare type AngleUnits = PercentUnits | "deg" | "rad" | "grad" | "turn";
...
export declare type CssAngle = number | IAngleProxy | `${number}${AngleUnits}`;
/**
...
export declare type CssTime = number | ITimeProxy | `${number}${TimeUnits}`;
/**
...
export declare type CssResolution = number | IResolutionProxy | `${number}${ResolutionUnits}`;
/**
...
export declare type CssFrequency = number | IFrequencyProxy | `${number}${FrequencyUnits}`;
/**
 ...
 * ```
 */
export declare type CssAspectRatio = CssNumber | IAspectRatioProxy | `${number}/${number}`;
/**
