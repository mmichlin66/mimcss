 ...
 */
export function $supports<T extends StyleDefinition>( statement: SupportsStatement,
 ...
 */
export function $media<T extends StyleDefinition>( statement: MediaStatement,
