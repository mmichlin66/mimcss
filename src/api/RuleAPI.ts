...
export abstract class StyleDefinition<P extends StyleDefinition = any> implements IStyleDefinition<P>
{
    ...
    public $layer(): ILayerNameRule | ILayerBlockRule | ILayerOrderRule
    {
        ...
        return argv.length < 2
            ? new LayerNameRule( this, arg1)
            : typeof arg2 === "function" || arg2 instanceof StyleDefinition
                ? new LayerBlockRule( this, arg1, arg2)
     ...
     */
    public $use<T extends StyleDefinition>( sdc: IStyleDefinitionClass<T>): T
    {
        return processSD( sdc) as T;
    }
}
 ...
 */
 export const pushRootContext = (root: DocumentOrShadowRoot, useAdoption = true): void =>
    s_pushRoot( root, useAdoption);
