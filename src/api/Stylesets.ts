...
// Augmenting the CSSStyleDeclaration interface to have a `$` property of Styleset type on style
// objects, which allows merging Stylesets or updating individual style properties using the
// Mimcss syntax.
declare global
{
