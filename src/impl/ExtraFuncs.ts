...
let Colors: INamedColors =
{
 ...
 export function getColorsObject(): INamedColors
 {
    return Colors;
 }
 ...
 */
export function rgb2s( r: Extended<number>, g: Extended<number>, b: Extended<number>, a?: Extended<number>): string
{
 ...
 */
export function color2s( val: Extended<CssColor>): string
{
    return v2s( val, {
